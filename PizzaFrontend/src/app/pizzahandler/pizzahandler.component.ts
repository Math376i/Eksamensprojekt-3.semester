...
@Component({
  selector: 'app-pizzahandler',
  templateUrl: './pizzahandler.component.html',
  styleUrls: ['./pizzahandler.component.css']
})
export class PizzahandlerComponent implements OnInit {
